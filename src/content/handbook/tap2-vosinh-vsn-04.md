---
title: "VSN-04: Vô sinh do Lạc nội mạc Tử cung"
description: "- **Định nghĩa chuẩn (theo ACOG/ASRM/WHO):** Lạc nội mạc tử cung (Endometriosis) là tình trạng các tế bào tương tự như nội mạc tử cung hiện diện và phát triển b"
pubDate: 2026-03-05
category: vo-sinh-hiem-muon
tags: ["DIE","TNF","PID","ART"]
...
|------------|---------|-------------------|--------------------|
| **AMH** | Đánh giá dự trữ buồng trứng | 2.0 - 6.8 ng/mL | Giảm mạnh nếu có Endometrioma hoặc sau phẫu thuật bóc nang. |
| **CA-125** | Chỉ dấu sinh học hỗ trợ | < 35 U/mL | Thường tăng nhẹ (35-100 U/mL) trong lạc nội mạc tử cung giai đoạn III-IV. |
| **AFC** | Đếm nang thứ cấp trên siêu âm | 5-10 nang/mỗi bên | Số lượng nang giảm ở bên có khối lạc nội mạc. |
...
|------|---------------------|
| **U nang buồng trứng xuất huyết** | Thường tự biến mất sau 1-2 chu kỳ kinh, đau cấp tính. |
...
## 9. CROSS-LINKS
- [VSN-01: Tiếp cận cặp vợ chồng vô sinh](VSN-01.md)
- [F-02: Đánh giá Dự trữ buồng trứng](F-02.md)
- [VSM-05: Lạc nội mạc trong cơ tử cung (Adenomyosis)](VSM-05.md)
