---
title: "VSN-10: Sẩy thai Liên tiếp (Recurrent Pregnancy Loss - RPL)"
description: "Chào đồng nghiệp, với tư cách là một bác sĩ lâm sàng và nhà quản lý hỗ trợ sinh sản, tôi hiểu rằng **Sẩy thai liên tiếp (RPL)** không chỉ là một thách thức về m"
pubDate: 2026-03-05
category: vo-sinh-hiem-muon
tags: ["RPL","BMI >30 kg/m2","NST","LPD","LA"]
...
- **Cơ chế bệnh sinh:**
    1. **Di truyền (Genetic):** Bất thường số lượng/cấu trúc nhiễm sắc thể (NST) của phôi (thường gặp nhất) hoặc do cha/mẹ mang chuyển đoạn cân bằng (Balanced translocation).
    2. **Miễn dịch (Immunologic):** Điển hình là Hội chứng kháng Phospholipid (Antiphospholipid Syndrome - APS) gây huyết khối vi mạch bánh nhau.
    3. **Giải phẫu (Anatomic):** Dị dạng tử cung bẩm sinh, polyp, nhân xơ dưới niêm mạc hoặc dính buồng tử cung (Asherman syndrome).
    4. **Nội tiết (Endocrine):** Suy hoàng thể (LPD), bệnh lý tuyến giáp, đái tháo đường kiểm soát kém, PCOS.
    5. **Tăng đông (Thrombophilia):** Các đột biến gen gây tăng đông máu hệ thống.
- **Phân loại:** 
...
## 9. CROSS-LINKS
- [VSN-01: Vô sinh Nữ - Tổng quan](VSN-01.md)
- [F-05: Thuốc hỗ trợ hoàng thể](F-05.md)

## 10. TÀI LIỆU THAM KHẢO
1. ESHRE Guideline: Recurrent Pregnancy Loss (Updated 2023).
2. ASRM Practice Committee Report: Evaluation and treatment of recurrent pregnancy loss (2020).
