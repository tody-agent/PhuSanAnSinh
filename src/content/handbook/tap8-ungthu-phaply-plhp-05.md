---
title: "PLHP-05: Đạo đức Y sinh trong ART"
description: "Chào đồng nghiệp, với tư cách là một người làm trong ngành Hỗ trợ sinh sản (ART), chúng ta hiểu rằng ART không chỉ là kỹ thuật thuần túy mà còn là một \"trận địa"
pubDate: 2026-03-05
category: phu-khoa
tags: ["ART","PGT","DIAGNOSIS","KTHT","PD"]
...
### 4.1 Kiểm tra sự đồng thuận (Informed Consent)
| Yếu tố | Mục đích | Tiêu chuẩn đạt |
|------------|---------|-------------------|
| Năng lực (Capacity) | Đảm bảo BN đủ minh mẫn | BN hiểu rõ rủi ro/lợi ích |
| Thông tin (Disclosure) | Cung cấp đầy đủ dữ liệu | Tỷ lệ thành công thực tế, chi phí |
| Tự nguyện (Voluntariness)| Tránh ép buộc | Không có áp lực từ gia đình/Xã hội |
...
## 9. CROSS-LINKS
- [KTHT-01: Quy trình IVF chuẩn](KTHT-01.md)
- [PD-01: Chẩn đoán di truyền tiền làm tổ PGT](PD-01.md)
- [PLHP-01: Luật pháp về Mang thai hộ tại Việt Nam](PLHP-01.md)
