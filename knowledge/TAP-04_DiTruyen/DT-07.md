...
- Chỉ định tư vấn và xem xét chuyển phôi khảm khi:
    1. Bệnh nhân thực hiện PGT-A (Xét nghiệm di truyền tiền làm tổ cho lệch bội) không có phôi nguyên bội (Euploid).
    2. Bệnh nhân có phôi khảm nhưng đã thất bại nhiều lần với phôi nguyên bội hoặc muốn dự trữ phôi nguyên bội cho tương lai.
    3. Cần mã hóa ICD-10: **Q99.8** (Các bất thường nhiễm sắc thể được xác định khác).
