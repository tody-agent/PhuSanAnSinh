...
|------------|---------|-------------------|--------------------|
| **Genetic Testing** | Xác định đột biến BRCA1/2 | Âm tính | Dương tính (Pathogenic variant) |
| **AMH (Anti-Mullerian Hormone)** | Đánh giá dự trữ buồng trứng trước FP | 2.0 - 6.8 ng/mL | < 1.0 ng/mL (Dự trữ thấp) |
| **IHC (Hóa mô miễn dịch)** | Xác định phân thể (ER, PR, HER2) | Tùy mẫu | TNBC thường gặp ở BRCA1 |
...
|------|---------------------|
| Thay đổi sợi bọc vú | Đau theo chu kỳ, khối u mềm, thay đổi theo nội tiết. |
