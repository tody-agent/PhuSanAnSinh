...
|------------|---------|-------------------|--------------------|
| **FSH** | Đánh giá trục hạ đồi-tuyến yên | < 10 IU/L | > 25 IU/L (thử 2 lần) |
| **Estradiol** | Đánh giá chức năng nội tiết | 30-400 pg/mL | < 20-30 pg/mL |
| **AMH** | Đánh giá dự trữ buồng trứng | 2.2 - 6.8 ng/mL | < 1.1 ng/mL (thường < 0.1) |
| **Karyotype** | Tìm bất thường nhiễm sắc thể | 46,XX | 45,X hoặc khảm |
| **Anti-TPO/Adrenal Ab** | Tầm soát bệnh tự miễn | Âm tính | Dương tính |
...
|------|---------------------|
| Vô kinh chức năng do hạ đồi | FSH thấp hoặc bình thường, liên quan đến stress/giảm cân. |
