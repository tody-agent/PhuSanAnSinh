...
1. Tuổi mẹ cao (≥ 40 tuổi) hoặc có yếu tố nguy cơ khác.
2. Tiền sử POR (thu được ≤ 3 noãn với phác đồ chuẩn).
3. Chỉ số OR bất thường (AFC < 5-7 hoặc AMH < 0.5-1.1 ng/mL).
...
1. **Cá thể hóa phác đồ (Individualized Controlled Ovarian Stimulation - iCOS):** Chọn loại thuốc và liều FSH khởi đầu (ví dụ: 150, 225 hay 300 IU).
2. **Lựa chọn phác đồ:** Antagonist protocol (phác đồ đối kháng) hiện được ưu tiên cho cả nhóm dự trữ thấp (để tránh ức chế quá mức) và dự trữ cao (để phòng ngừa OHSS).
3. **Quản lý kỳ vọng:** Tư vấn cho bệnh nhân về số lượng noãn dự kiến thu được, giảm sốc tâm lý khi kết quả không như ý.

---

## 8. Các phương pháp "cải thiện" dự trữ buồng trứng: Sự thật hay Huyền thoại?
Cần khẳng định: **Không có thuốc nào có thể làm tăng số lượng nang nguyên thủy.**
Tuy nhiên, một số liệu pháp bổ trợ có thể cải thiện môi trường vi thể của nang noãn đang phát triển:
...
> 📚 **THAM KHẢO:**
> 1. ASRM Committee Opinion No. 612: Testing and interpreting measures of ovarian reserve.
> 2. ESHRE Guideline: Ovarian Stimulation for IVF/ICSI (2019).
> 3. The POSEIDON Criteria (2016): A New Era in Reproductive Medicine.
