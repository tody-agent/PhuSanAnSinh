...
1.  **Vô sinh do nam giới (Male Factor Infertility).**
2.  **Rối loạn phóng noãn (Ovulatory Dysfunction - ví dụ: PCOS - Hội chứng buồng trứng đa nang).**
3.  **Vô sinh do vòi trứng/phúc mạc (Tubal/Peritoneal Factor).**
4.  **Vô sinh do tử cung (Uterine Factor).**
5.  **Vô sinh chưa rõ nguyên nhân (Unexplained Infertility):** Chiếm khoảng 15-30% trường hợp khi tất cả các xét nghiệm cơ bản đều bình thường.

---

## Flowchart Tiếp cận Hệ thống (Phác đồ tóm tắt)

1.  **Tư vấn ban đầu:** Khám lâm sàng + Khai thác bệnh sử 2 vợ chồng.
2.  **Xét nghiệm song song:**
    - Vợ: Siêu âm phụ khoa, xét nghiệm nội tiết, đánh giá dự trữ buồng trứng (AMH/AFC).
    - Chồng: Tinh dịch đồ (Semen Analysis).
3.  **Đánh giá hình thái:** HSG hoặc HyCoSy để kiểm tra vòi trứng.
4.  **Chẩn đoán xác định:** Tổng hợp kết quả và phân loại theo ICD-10.
...
- **Lộ trình điều trị:** 
    1. Thay đổi lối sống, giảm cân. 
    2. Kích thích buồng trứng bằng Letrozole + Giao hợp tự nhiên hoặc IUI.
    3. Nếu thất bại 3-6 chu kỳ -> Chuyển sang IVF.

---

> 💊 **GHI CHÚ LÂM SÀNG:** 
> Đừng bao giờ điều trị kích thích buồng trứng cho người vợ mà chưa có kết quả tinh dịch đồ của người chồng. Đây là sai lầm phổ biến dẫn đến lãng phí thời gian và nguy cơ đa thai không đáng có.

> ⚠️ **CỜ ĐỎ (RED FLAGS):**
> Cần chuyển tuyến chuyên khoa hỗ trợ sinh sản (IVF) ngay nếu:
> 1. Người vợ > 40 tuổi bất kể nguyên nhân.
> 2. AMH < 0.5 ng/mL.
> 3. Tắc cả hai vòi trứng trên HSG.
> 4. Chồng vô tinh (Azoospermia).

> 📚 **THAM KHẢO (GUIDELINES):**
> 1. ASRM (American Society for Reproductive Medicine) - Diagnostic evaluation of the infertile female/male (2021).
> 2. ESHRE (European Society of Human Reproduction and Embryology) - Management of women with PCOS.
