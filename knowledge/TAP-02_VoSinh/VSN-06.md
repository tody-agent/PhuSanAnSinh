...
- **Định nghĩa chuẩn (theo ESHRE/ACOG):** Suy buồng trứng sớm (POI) là tình trạng mất chức năng hoạt động bình thường của buồng trứng ở phụ nữ dưới 40 tuổi. Đặc trưng bởi sự kết hợp của:
    ...
    2. Nồng độ Gonadotropin (FSH) tăng cao trong phạm vi mãn kinh (thường > 25 IU/L) được đo 2 lần cách nhau ít nhất 4 tuần.
    3. Nồng độ Estrogen giảm thấp.
- **Tần suất/Tỷ lệ:**
...
- **Cơ chế bệnh sinh:** Gồm hai cơ chế chính:
    1. **Cạn kiệt nang noãn (Follicle depletion):** Do số lượng nang noãn ban đầu thấp (bất thường di truyền) hoặc tốc độ thoái hóa nang noãn quá nhanh (iatrogenic, nhiễm độc).
    2. **Rối loạn chức năng nang noãn (Follicle dysfunction):** Nang noãn vẫn còn nhưng không đáp ứng với kích thích của Gonadotropin (đột biến receptor, tự miễn).
- **Phân loại:**
...
## 9. CROSS-LINKS
- [VSN-01: Tiếp cận bệnh nhân vô kinh](VSN-01.md)
- [KTHT-04: Quy trình Xin - Cho noãn](KTHT-04.md)
- [DT-02: Hội chứng Turner và sinh sản](DT-02.md)

## 10. TÀI LIỆU THAM KHẢO
1. ESHRE Guideline: Management of women with premature ovarian insufficiency (2016).
2. ACOG Practice Bulletin No. 141: Premature Ovarian Insufficiency (Reaffirmed 2020).
