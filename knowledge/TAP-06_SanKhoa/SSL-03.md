...
|------------|---------|-------------------|--------------------|
| **NIPT (cfDNA)** | Sàng lọc T21, 18, 13, NST giới tính | Nguy cơ thấp (Low Risk) | Nguy cơ cao (High Risk/Positive) |
| **Fetal Fraction** | Kiểm tra chất lượng mẫu | > 4% | < 4% (Cần lấy mẫu lại hoặc chọc ối) |
| **Z-score** | Chỉ số thống kê độ lệch | Thường < 3 | > 3 (Gợi ý lệch bội) |
...
| **Vanished Twin** | Thai đôi tiêu biến, DNA của thai lưu gây nhiễu kết quả. |
| **Bất thường của mẹ** | Mẹ bị ung thư hoặc mẹ có bất thường số lượng NST (Mosaicism). |
