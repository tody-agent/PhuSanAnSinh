...
- **Cơ chế chính:**
    1. **Ức chế rụng trứng (Inhibition of Ovulation):** Cơ chế phản hồi âm tính lên trục Hạ đồi - Tuyến yên - Buồng trứng (ví dụ: thuốc nội tiết kết hợp).
    2. **Ngăn cản sự thụ tinh (Prevention of Fertilization):** Tạo rào cản vật lý (Bao cao su) hoặc làm bất động tinh trùng (Dụng cụ tử cung chứa đồng).
    3. **Thay đổi môi trường đường sinh dục (Hostile Environment):** Làm đặc dịch nhầy cổ tử cung (Progestin-only) hoặc gây teo nội mạc tử cung để ngăn sự làm tổ (Implantation).
...
1. WHO Medical Eligibility Criteria for Contraceptive Use (5th edition, 2015).
2. ACOG Practice Bulletin No. 206: Use of Contraception in Women With Medical Comorbidities.
